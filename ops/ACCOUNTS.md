...
No account has been created during the mission.

Pre-existing authorised connections in use:

| Service | Purpose | Account identifier in Git | Created during mission | Cost | Renewal risk | Cancellation requirement |
|---|---|---|---|---:|---|---|
